...
@interface CryptoTrayAppDelegate: NSObject <NSApplicationDelegate>
  - (void) add_or_update_menu_item:(MenuItem*) item;
  - (IBAction)menuHandler:(id)sender;
  @property (assign) IBOutlet NSWindow *window;
  @end

  @implementation CryptoTrayAppDelegate
{
...
void registerSystray(void) {
  ...
  owner = [[CryptoTrayAppDelegate alloc] init];
